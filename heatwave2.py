...
def update(frame):
  tim = frame
  depth = 1
  timedata.append(frame)
  Tempdata.append(T(depth, tim))
  curve.set_data(timedata, Tempdata)
  return curve 
...
frames = linspace(t0, tmax, int(100))
ani = FuncAnimation(fig, update, frames = frames, blit = False, interval = 30) 
ani.save("heatwave.gif")
